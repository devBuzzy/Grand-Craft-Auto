...
public class Settings implements Displayable {
	...
	public static ItemStack gspartic01 = ItemUtils.getItem(Material.INK_SACK, (short) 1, "&6Gun Shot Particles &2(&aOn&2)",
			"Toggle Particles that", "follows every shot`s visibility");
	public static ItemStack gspartic02 = ItemUtils.getItem(Material.INK_SACK, 2, (short) 1, "&6Gun Shot Particles &4(&cOff&4)", 
			"Toggle Particles that", "follows every shot`s visibility");
	
	public static ItemStack greffect = ItemUtils.getItem(Material.INK_SACK, (short) 2, "&bGun Recharge Effect &5(&9%state%&5)", "Change animation when", "you recharge your guns");
	public static ItemStack greffect01(String state) {return replace(greffect.clone(), state);}
	
	public static ItemStack titles01 = ItemUtils.getItem(Material.PAPER, "&aTitles &2(&aOn&2)");
	public static ItemStack titles02 = ItemUtils.getItem(Material.PAPER, 2, (short) 0, "&aTitles &4(&cOff&4)");
	
	public static ItemStack hotbar01 = ItemUtils.getItem(Material.COMPASS, (short) 0,
			"&9Hotbar Messages &2(&aOn&2)", "Toggle Hotbar Messages", "&4Warning: &fSome messages", "&fWill still being displayed");
	public static ItemStack hotbar02 = ItemUtils.getItem(Material.COMPASS, 2, (short) 0, 
			"&9Hotbar Messages &4(&cOff&4)", "Toggle Hotbar Messages", "&4Warning: &fSome messages", "&fWill still being displayed");
	
	public static ItemStack gzoom01 = ItemUtils.getItem(Material.INK_SACK, (short) 3, 
			"&eGun Zoom &2(&a%state%&2)", "Toggles Zoom when you", "use zoom on your guns", "&fWill not affect", "&fNight Vision");
	public static ItemStack gzoom02 = ItemUtils.getItem(Material.INK_SACK, 2, (short) 3, 
	...
	public static ItemStack pvisibility01 = ItemUtils.getItem(Material.MONSTER_EGG, (short) 95, "&dPet Visibility &2(&aOn&2)");
	public static ItemStack pvisibility02 = ItemUtils.getItem(Material.MONSTER_EGG, 2, (short) 95, "&dPet Visibility &4(&cOff&4)");
	
	public static ItemStack eparticles01 = ItemUtils.getItem(Material.FIREWORK, "&fExtra Particles &2(&aOn&2)", "Toggles All particles", "Generated by plugin");
	public static ItemStack eparticles02 = ItemUtils.getItem(Material.FIREWORK, 2, (short) 0, "&fExtra Particles &4(&cOff&4)", "Toggles All particles", "Generated by plugin");
	...
	public static Inventory inv1 = extraMenu(null, menu01N(), ItemUtils.getItem(Material.INK_SACK, (short) 1, 
			menu01N() + state(), gspartic01.getItemMeta().getLore()), SettingsEnum.GUN_SHOT_PARTICLES);
	public static Inventory inv2 = extraMenu(null, menu02N(), ItemUtils.getItem(Material.INK_SACK, (short) 2, 
	...
	public void display(Player p) {
		...
		for (int n = 1; n <= inv.getSize(); n++) inv.setItem(n-1, ItemUtils.ItemDefault());
	...
	public static Inventory extraMenu(List<Integer> slot, String title, ItemStack i, SettingsEnum settings) {
		...
		for (ItemStack is : inv) {
			if (is == null) inv.setItem(n, ItemUtils.ItemDefault());
			n++;
		}
		return inv;
	}
