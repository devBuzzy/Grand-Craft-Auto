...
public class Titles {
	...
	public Titles(Player p) { con = ((CraftPlayer) p).getHandle().playerConnection; }
	public Titles(Player p, String title) { con = ((CraftPlayer) p).getHandle().playerConnection; title(title); }
